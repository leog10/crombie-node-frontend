    ...
    return (
        <div>
            <div className="input-container">
                <input maxLength={15} max={5000000} className={error ? 'input-error' : value ? 'input-ok' : ''} spellCheck={false} onFocus={() => setFocus(!focus)} onBlur={handleOnBlur} required value={value ? value : ''} id={name} name={name} type={type} onChange={(e) => handleOnChange(e.target.value)} />
